...
set output 'results/Vm_Neuron.png'

# Set plot title and axis labels
set title 'Vm Hodgkin-Huxley Model'
set xlabel 'Time (ms)'
...
plot 'results/time_series_Hodgkin-Huxley.csv' using 1:2 with lines linestyle 1 title 'Vm'
